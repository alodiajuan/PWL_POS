...
Route::middleware(['auth'])->group(function() {
    ...
    Route::middleware(['auhorize:ADM'])->group(function(){
        Route::get('/level', [LevelController::class, 'index']);
...
Route::middleware(['auth'])->group(function() {
    ...
    Route::middleware(['auhorize:ADM, MNG'])->group(function(){
        ...
        Route::get('/barang/{id}/edit_ajax', [BarangController::class, 'update_ajax']);
        Route::put('/barang/{id}/delete_ajax', [BarangController::class, 'confirm_ajax']);
